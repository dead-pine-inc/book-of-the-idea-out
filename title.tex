...
\begin{center}
    ...
    \begin{itemize}
        ...
        \item Илиа --- автор-эстет и \miama{художественный} редактор
    \end{itemize}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.65\textwidth]{hip-zen}
    \caption{\href{https://www.instagram.com/funnyezo/}{\#funnyezo}}
\end{figure}
